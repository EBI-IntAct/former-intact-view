...
TooltipManager = {
  ...
  options: {cssClassName: 'tooltip', delayOver: 0, delayOut: 0, shiftX: -14, shiftY: 0,
            //className: 'alphacube', width: 200, height: null,
			className: 'mac_os_x', width: 230, height: null, //RC
            draggable: false, minimizable: false, maximizable: false, closable: false, showEffect: Element.show, hideEffect: Element.hide},
  ajaxInfo: null,
  elements: null,
  showTimer: null,
  hideTimer: null,
  ...
  _showTooltip: function(element) {
    ...
    //Event.observe(this.tooltipWindow.element, "mouseover", function(event) {TooltipManager._tooltipOver(event, element)}); // Hide by RAFA
