...
switch (skinName) {
case 'win2k':
this.imgDir       = '/_bsJavascript/components/checkbox/img/win2k/';this.imgWidth     = '20';this.imgHeight    = '20';break;case 'osx':
this.imgDir       = '/_bsJavascript/components/checkbox/img/osx/';this.imgWidth     = '14';this.imgHeight    = '16';break;case 'opera7':
this.imgDir       = '/_bsJavascript/components/checkbox/img/opera7/';this.imgWidth     = '14';this.imgHeight    = '14';break;case 'bobby':
this.imgDir       = '/_bsJavascript/components/checkbox/img/bobby/';this.imgWidth     = '11';this.imgHeight    = '11';this.imgStyle     = 'margin:3px; vertical-align:middle;';this.useMouseover = true;break;case 'yattacier3':
this.imgDir       = '/_bsJavascript/components/checkbox/img/yattacier3/';this.imgWidth     = '13';this.imgHeight    = '13';break;case 'h2ogtk2':
this.imgDir       = '/_bsJavascript/components/checkbox/img/h2ogtk2/';this.imgWidth     = '13';this.imgHeight    = '13';break;case 'aluminumalloyvolcanic':
this.imgDir       = '/_bsJavascript/components/checkbox/img/aluminumalloyvolcanic/';this.imgWidth     = '14';this.imgHeight    = '16';break;case 'smoothstreak':
this.imgDir       = '/_bsJavascript/components/checkbox/img/smoothstreak/';this.imgWidth     = '13';this.imgHeight    = '13';break;case 'ximian-industrial':
case 'ximian_industrial':
this.imgDir       = '/_bsJavascript/components/checkbox/img/ximian_industrial/';this.imgWidth     = '13';this.imgHeight    = '13';break;default:
return false;}
    return true;
};
